...
def get_cards_table():
    ...
    cards_list = [{
       ...
       "media_img_id": os.path.join(Config.SUPABASE_STORAGE_URL, get_media_path(card.media_img_id, "image")) if card.media_img_id else None,
        "media_vid_id": os.path.join(Config.SUPABASE_STORAGE_URL, get_media_path(card.media_vid_id, "video")) if card.media_vid_id else None,
        "media_doc_id": os.path.join(Config.SUPABASE_STORAGE_URL, get_media_path(card.media_doc_id, "doc")) if card.media_doc_id else None,
