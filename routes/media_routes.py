...
def fetch_all_media():
    ...
    return jsonify([{
        ...
        "media_img_id": os.path.join(Config.SUPABASE_STORAGE_URL, get_media_path(media.media_img_id)) if media.media_img_id else None,
        "media_vid_id": os.path.join(Config.SUPABASE_STORAGE_URL, get_media_path(media.media_vid_id)) if media.media_vid_id else None,
        "media_doc_id": os.path.join(Config.SUPABASE_STORAGE_URL, get_media_path(media.media_doc_id)) if media.media_doc_id else None,
